...
public class RightFlipper extends Flipper{
    ...
    public RightFlipper(double xloc, double yloc, Angle orientation, List<Gadget> triggeredGadgets) {
    ...
    public RightFlipper(double xloc, double yloc, Angle orientation) {
    ...
    public RightFlipper(double xloc, double yloc) {
    ...
    public RightFlipper(double xloc, double yloc,List<Gadget> triggeredGadgets) {
    ...
    public List<DoublePair> toConsoleCoordinates() {
        ...
        if (isVerticle){
            if (orientation == Angle.ZERO || orientation == Angle.DEG_90) xLoc+=1;
            coordinates.add(new DoublePair(xLoc, yLoc));
            coordinates.add(new DoublePair(xLoc, yLoc+1));

        } else {
            if (orientation == Angle.DEG_90 || orientation == Angle.DEG_180) yLoc+=1;
            coordinates.add(new DoublePair(xLoc, yLoc));
